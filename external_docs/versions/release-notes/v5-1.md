...
> upgraded **as soon as** they have been released by the Apache Software Foundation. See below.
...
- Improved legacy password checking on the API endpoint when calling services with basic auth credentials.
  ...
  (see [the release note](/versions/release-notes/v5-2#compatibility-breaking-changes) for details)
...
This is the **final** revision for this minor version 5.1, no further maintenance will be done on it.
