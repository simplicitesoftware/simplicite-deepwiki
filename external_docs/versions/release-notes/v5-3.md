...
### 5.3.90 (UNRELEASED) - maintenance revision {#version-5.3.90}

- Backported [from v6.3](v6-3#version-6.3.10) fin on email regex to allow legit stacked dashes/plus signs
