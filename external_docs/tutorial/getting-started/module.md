...
A module in Simplicité is the fundamental unit that encapsulates all configuration objects of an application,
serving as its exportable configuration package...
...
1. Do one of the following :
   ...
   - Click **Creation assistant** in _Project > Modules_
...
4. Fill in the Group fields like so :
   - Name : **TRN_SUPERADMIN** _(if you entered a prefix in the previous step, the platform will suggest a group name that respects the conventions)_
