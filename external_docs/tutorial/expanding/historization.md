...
A Change Log allows to monitor all of the changes done to a record...

[Learn more](/make/operation/sessions/change-log)
...
7. Change the **Module Name** to "Training" :
   ...
   - Click the _magnifying glass_ button and select Training
