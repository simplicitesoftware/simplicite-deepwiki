...
### 5.3.80 (UNRELEASED) - maintenance revision {#version-5.3.80}

- Backported [from v6.2](v6-2#version-6.2.18) fix XML import final `status KO` in case of unknown references after recycling
