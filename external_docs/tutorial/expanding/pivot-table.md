...
Pivot tables provide a powerful way to analyze data by cross-referencing fields within a business object.
Users can configure tables by selecting which fields appear as rows, columns, and values,
with various customization options like filtering, axis swapping, and export capabilities...

[Learn more](/make/userinterface/objectsrendering/pivot-table)
...
3. Fill in the Pivot table information like so :
   ...
   - _other required values should be set by default_
...
2. Fill in the Pivot table axis information like so :
    - Object :
        - Click the _magnifying glass_ icon
...
- In the _Chart_ tab, you can generate a chart for the pivot table.
- The _Search_ button filters the data used for the pivot table
