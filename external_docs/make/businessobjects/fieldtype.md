...
In **Simplicité**, a **Field Type** defines the format, validation rules, and behavior of a field within a business object.
Field Types ensure that data entered in fields complies with specific formats or constraints, using predefined validation methods or regular expressions.

They are reusable definitions that can be associated with multiple fields across objects,
standardizing input formats (e.g., alphanumeric codes, emails, dates).
...
| ----------------- | -------------------------------------------------- | ----------------------------------- | -------------- |
| `ALPHA`           | n/a                                                | `^[a-zA-Z]+$`                       | System         |
| `ALPHANUM`        | n/a                                                | `^[a-zA-Z0-9]+$`                    | System         |
| `EMAIL`           | n/a                                                | `^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*$` | System         |
| `EAN13`           | `com.simplicite.util.tools.BarcodeTool.checkEAN13` | n/a                                 | System         |
| `COLOR`           | n/a                                                | `#RRGGBB` or `rgba(...)`            | System         |
| `NUM`             | n/a                                                | `^[0-9]+$`                          | System         |
| `PHONENUM`        | n/a                                                | `^\+?[0-9 ]+$`                      | System         |
