...
It is considered as a [business object](/make/businessobjects/business-objects) by the platform
and therefore benefits from the same functionalities (search, list, form, cross tables, publication, etc.).
...
4. set the **Timestamp** attribute of the object to the "None" value (_or, alternatively, adding attributes for the timestamp values_)
