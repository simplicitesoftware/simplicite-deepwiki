...
<TabItem value="alamlinux8-centos-debian" label="AlmaLinux 8/9/10 or CentOS 7 or Debian">
```shell
...
<TabItem value="almalinux9-almalinux10" label="AlmaLinux 9 or 10">
```shell
podman run -it --rm -p 80:8080 registry.simplicite.io/server:latest
```
</TabItem>
<TabItem value="almalinux8-centos-debian" label="AlmaLinux 8 or CentOS 7 or Debian">
```shell
sudo docker run -it --rm -p 80:8080 registry.simplicite.io/server:latest
```
</TabItem>
</Tabs>
