...
A Field Area groups related fields in forms and lists for better organization...

[Learn more](/make/userinterface/templating/fields-areas)
...
1. Hover over the previously created Field Area, click the _Edit_ icon
   ![](img/fieldarea/edit-field-area.png)
2. Fill in the Field Area information like so :
   - Label : **Product**
   - Icon code : **products** (_you can also use the icon picker to select an icon_)
...
2. Click and hold the _move_ icon
