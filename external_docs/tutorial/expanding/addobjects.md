...
All of the steps in **Getting started** are completed
...
Follow the steps in [Getting started : Create object](/tutorial/getting-started/object) to create the
Client Business object with the following properties:
...
Follow the steps in [Getting started : Create object](/tutorial/getting-started/object) to create the Order Business
