...
A Link in Simplicité represents a relationship between Business objects. It is defined physically
by a foreign key in the database and configured using an Object field...

[Learn more](/make/businessobjects/links)
...
At step 6, in the search box, enter **TrnClient** instead of TrnProduct.
