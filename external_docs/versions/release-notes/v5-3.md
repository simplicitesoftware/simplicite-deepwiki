...
- Backported [from v6.3](v6-3#version-6.3.13) missing branch in the `module-info.json` file
...
- Updated Java libs.
- Security fix.
- Backported [from v6.3](v6-3#version-6.3.16) fix for duplicate error messages on hidden fields
